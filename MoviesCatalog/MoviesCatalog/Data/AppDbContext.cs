    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MovieActor>().HasData(
                new MovieActor { MovieId = 1, ActorId = 3 }, // Inception - DiCaprio
                new MovieActor { MovieId = 1, ActorId = 4 }, // Inception - Johansson
                new MovieActor { MovieId = 2, ActorId = 1 }, // Dark Knight - Tom Cruise (example)
                new MovieActor { MovieId = 2, ActorId = 2 }, // Dark Knight - Brad Pitt (example)
                new MovieActor { MovieId = 3, ActorId = 2 }, // Pulp Fiction - Brad Pitt
                new MovieActor { MovieId = 3, ActorId = 5 }, // Pulp Fiction - Denzel
                new MovieActor { MovieId = 4, ActorId = 4 }, // Matrix - Scarlett
                new MovieActor { MovieId = 4, ActorId = 3 }, // Matrix - DiCaprio
                new MovieActor { MovieId = 5, ActorId = 3 }  // Forrest Gump - DiCaprio
            );
        }
    }
}